...
namespace Frost.Scripting.Compiler
{
	...
	public class Lexer : IFullDisposable
	{
		...
		private void expect (char expected)
		{
			...
			{
				if(actual != expected)
					throw new Exception(String.Format("Expected {0}, but got {1}", expected, actual)); // TODO: ParserException
			}
			else
				throw new Exception(String.Format("Unexpected end of file reached. Expected {0}", expected)); // TODO: ParserException
		}
